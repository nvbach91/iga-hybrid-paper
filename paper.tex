...
\usepackage{listings}
\lstset{language=SQL,morekeywords={CONSTRUCT,OPTIONAL,BIND,PREFIX,FILTER,BOUND,LANGMATCHES,LANG}}
\usepackage{ragged2e}
\setcitestyle{square}
...
\input{sections/02-codelist-def}
%\input{sections/02-structural-parts}
\input{sections/03-code-list-analyzer}
\input{sections/04-code-list-gathering}
\input{sections/05-representation-approaches}
\input{sections/06-manual-analysis}
